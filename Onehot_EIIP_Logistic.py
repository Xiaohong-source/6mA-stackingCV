...
Rosaceae_train,Rosaceae_train_y = Onehot_EIIP('Datasets/Training_Dataset/positive_training_dataset_for_Rosaceae.txt','Datasets/Training_Dataset/negative_training_dataset_for_Rosaceae.txt')
Rosaceae_test,Rosaceae_test_y = Onehot_EIIP('Datasets/Test_Dataset/positive_test_dataset_for_Rosaceae.txt','Datasets/Test_Dataset/negative_test_dataset_for_Rosaceae.txt')
Arabidopsis_test,Arabidopsis_test_y = Onehot_EIIP('Datasets/Test_Dataset/positive_test_dataset_for_Arabidopsis_Thaliana.txt','Datasets/Test_Dataset/negative_test_dataset_for_Arabidopsis_Thaliana.txt')
Rice_test,Rice_test_y = Onehot_EIIP('Datasets/Test_Dataset/positive_test_dataset_for_Rice.txt','Datasets/Test_Dataset/negative_test_dataset_for_Rice.txt')
