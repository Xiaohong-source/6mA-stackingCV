...
import numpy as np
from data_processing import Onehot_EIIP, Onehot_ENAC
import matplotlib.pyplot as plt
from sklearn.metrics import roc_curve,auc

model = 'Onehot_ENAC_Logistic'
...
Rosaceae_train,Rosaceae_train_y = Onehot_ENAC('Datasets/Training_Dataset/positive_training_dataset_for_Rosaceae.txt','Datasets/Training_Dataset/negative_training_dataset_for_Rosaceae.txt')
Rosaceae_test,Rosaceae_test_y = Onehot_ENAC('Datasets/Test_Dataset/positive_test_dataset_for_Rosaceae.txt','Datasets/Test_Dataset/negative_test_dataset_for_Rosaceae.txt')
Arabidopsis_test,Arabidopsis_test_y = Onehot_ENAC('Datasets/Test_Dataset/positive_test_dataset_for_Arabidopsis_Thaliana.txt','Datasets/Test_Dataset/negative_test_dataset_for_Arabidopsis_Thaliana.txt')
Rice_test,Rice_test_y = Onehot_ENAC('Datasets/Test_Dataset/positive_test_dataset_for_Rice.txt','Datasets/Test_Dataset/negative_test_dataset_for_Rice.txt')
...
stack = StackingCVClassifier(
    classifiers=[model1,model2,model3], meta_classifier=model4, random_state=10,use_probas=True,cv=5,n_jobs=-1)
